...
//! Product B ("blinkb") — nRF5340 application-core blink firmware.
//!
...
/// This product blinks at 4x the shared base period (400 ms).
const PERIOD_MULT: u16 = 4;
...
fn main() -> ! {
    ...
    // nRF5340-DK LED2 = P0.29 (cosmetic; the test asserts on RTT, not the pin).
    let mut led = port0.p0_29.into_push_pull_output(hal::gpio::Level::High);

    rprintln!("blinkb blink demo start");

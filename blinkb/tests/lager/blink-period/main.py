"""blinkb blink-period — directory-module HIL test (lager python convention).
...
Run via the PR Reviewer, or manually from the repo root:
    ...
    lager python blinkb/tests/lager/blink-period --box <BOX> -- -v
...
@click.option("--elf", default="blinkb", show_default=True,
